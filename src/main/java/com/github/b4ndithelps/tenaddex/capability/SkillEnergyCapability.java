package com.github.b4ndithelps.tenaddex.capability;
 ...
 */
@Mod.EventBusSubscriber(modid = TensuraAddonExample.MODID)
public class SkillEnergyCapability {
    ...
    public static final ResourceLocation ID = new ResourceLocation(TensuraAddonExample.MODID, "skill_energy");
