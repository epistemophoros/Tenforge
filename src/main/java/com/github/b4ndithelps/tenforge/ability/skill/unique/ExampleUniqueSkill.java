...
public class ExampleUniqueSkill extends Skill {
    ...
    public ResourceLocation getSkillIcon() {
        return new ResourceLocation(Tenforge.MODID, "textures/skill/unique/example_unique.png");
    }
    ...
    public Component getModeName(int curMode) {
        ...
        switch (curMode) {
            case 1 -> name = Component.translatable("tenforge.skill.mode.example_unique.boom");
            case 2 -> name = Component.translatable("tenforge.skill.mode.example_unique.big_boom");
